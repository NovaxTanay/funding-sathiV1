        ...
        <div className="hidden md:block relative z-10 w-[850px] max-w-full min-h-[500px]
          ...
          >
            ...
            {router.query.logout === 'true' && (
              <div className="w-full max-w-xs mb-4 text-xs font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-white/5 py-2.5 px-4 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm text-center">
